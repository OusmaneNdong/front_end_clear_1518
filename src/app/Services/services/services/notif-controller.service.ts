...
import { sendEmail } from '../fn/notif-controller/send-email';
import { SendEmail$Params } from '../fn/notif-controller/send-email';

@Injectable({ providedIn: 'root' })
export class NotifControllerService extends BaseService {
